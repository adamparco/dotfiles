...
hi Cursor       ctermfg=11          ctermbg=None       cterm=None
hi SpecialKey	ctermfg=234         ctermbg=None       cterm=Bold
hi Directory	ctermfg=76          ctermbg=None       cterm=None
hi ErrorMsg     ctermfg=124         ctermbg=None       cterm=None
hi PreProc	    ctermfg=52          ctermbg=None       cterm=Bold
hi Search	    ctermfg=232         ctermbg=160        cterm=Bold
"IncSearch
...
hi Error	    ctermfg=None        ctermbg=219        cterm=Bold
...
hi LineNr	    ctermfg=234         ctermbg=None       cterm=Bold

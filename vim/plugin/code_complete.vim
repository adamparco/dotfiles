...
let g:template['c']['switch'] = "switch( ".g:rs."...".g:re." ){\<cr>case ".g:rs."...".g:re.":\<cr>break;\<cr>case ".
            \g:rs."...".g:re.":\<cr>break;\<cr>default:\<cr>".g:rs."...".g:re.";\<cr>break;\<cr>}"
...
let g:template['c']['print'] = "printf(\"\\n\");\<left>\<left>\<left>\<left>\<left>"

let g:template['c']['program'] = "#include <string.h>\<cr>#include <stdio.h>\<cr>#include <stdint.h>\<cr>\<cr>int main(int argc, char \*argv\[\])\<cr>{\<cr>".
            \g:rs."...".g:re.";\<cr>return (0);\<cr>}"
